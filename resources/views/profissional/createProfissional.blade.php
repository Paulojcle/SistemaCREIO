  ...
  <div class="prof-card">
    ...
    <form action="{{ route('profissionais.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="foto-picker-wrap">
        ...
        <label class="foto-picker-btn" for="foto" title="Clique para selecionar uma foto">
          <img id="foto-preview" src="https://ui-avatars.com/api/?name=Novo&background=c8d8e8&color=555&size=110" alt="Preview">
